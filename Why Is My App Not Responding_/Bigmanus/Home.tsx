          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {isAuthenticated ? (
                <>
                  <Link href="/dashboard">
                    <div className="px-4 py-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-md transition-colors cursor-pointer">
                      Dashboard
                    </div>
                  </Link>
                  <Link href="/analytics">
                    <div className="px-4 py-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-md transition-colors cursor-pointer flex items-center">
                ...
                <>
                  ...
                  <a href={getLoginUrl()} className="px-4 py-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-md transition-colors cursor-pointer inline-block">
                    Sign In
                  </a>
                  <a href={getLoginUrl()} className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-md transition-colors cursor-pointer inline-flex items-center">
        ...
        <div className="container relative">
          <div className="mx-auto max-w-5xl text-center space-y-8">
            ...
            <div className="flex justify-center mb-6">
              <img 
                src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663256154508/IOOqLaYWAdfMtxRH.png" 
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-purple-500/30">
                <div className="aspect-video bg-gradient-to-br from-purple-900/50 to-pink-900/50 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-2xl font-semibold text-white">Watch Lecture Me in Action</p>
                    <p className="text-gray-300">See how AI transforms your study materials in seconds</p>
        ...
        <div className="container">
          <div className="text-center space-y-4 mb-14">
            ...
            <div className="flex justify-center mb-4">
              <img 
                src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663256154508/REZHhJTTWcVWZSIV.png" 
                alt="Lecture Me Robot" 
                className="w-24 h-24 drop-shadow-xl animate-bounce"
              />
            </div>
